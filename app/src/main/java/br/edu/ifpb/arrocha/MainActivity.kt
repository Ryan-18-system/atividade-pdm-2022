        ...
        override fun onClick(p0: View?) {
            try {
                ...
                if (this@MainActivity.arrocha.getStatus() == Status.EXECUTANDO) {
                    ...
                    var intent = Intent(this@MainActivity, ResultadoActivity::class.java).apply {
                ...
                Toast.makeText(this@MainActivity, "Informe um número válido", Toast.LENGTH_SHORT).show()
            }
        }
    }
